...
var Base = function (_EventEmitter) {
  ...
  _createClass(Base, [{
    ...
    value: function send(bot) {
      ...
      var expectAnswer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      ...
      return new Promise(function (resolve, reject) {
        _this2._apiSend(bot).then(function (response) {
    ...
    value: function disableNotification() {
